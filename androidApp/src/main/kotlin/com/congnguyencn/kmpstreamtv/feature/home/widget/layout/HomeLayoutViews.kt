...
abstract class HomeLayoutBaseView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
    defStyleRes: Int = 0,
) : FrameLayout(context, attrs, defStyleAttr, defStyleRes), HomeLayoutItemClickable {
...
class LayoutGeneralView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
    defStyleRes: Int = 0,
    ...
    fun bindLayout(data: HomeSectionUiModel) = with(binding) {
        ...
        rcvItems.minimumHeight = when (data.presentation) {
            HomeSectionPresentation.GeneralWide -> resources.getDimensionPixelSize(R.dimen.ephemeral_wide_thumbnail_height)
            HomeSectionPresentation.GeneralTall -> resources.getDimensionPixelSize(R.dimen.ephemeral_tall_thumbnail_height)
            HomeSectionPresentation.Circle -> resources.getDimensionPixelSize(R.dimen.circle_icon_size)
            HomeSectionPresentation.Short -> resources.getDimensionPixelSize(R.dimen.short_thumbnail_height)
            else -> 0
        }
        if (data.presentation == HomeSectionPresentation.Short) bindShort()
    }

    private fun bindShort() = with(binding) {
...
class LayoutStory @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
    defStyleRes: Int = 0,
    ...
    private fun bindStoryChrome() = with(binding) {
...
class LayoutWatching @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
    defStyleRes: Int = 0,
    ...
    private val binding = LayoutViewBinding.inflate(LayoutInflater.from(context), this, true)
    private val adapter = HomeContentAdapter(HomeContentStyle.ContinueWatching) { item -> onContentClick?.invoke(item) }
...
class LayoutBackgroundView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
    defStyleRes: Int = 0,
    ...
    private val maxWidthTitle = resources.getDimensionPixelSize(R.dimen.top_ten_title_width) +
...
class LayoutMiniApp @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
    defStyleRes: Int = 0,
...
internal fun HomeSectionPresentation.toContentStyle(): HomeContentStyle = when (this) {
