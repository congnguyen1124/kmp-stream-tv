...
class CarouseView
    ...
    constructor(
        ...
        init {
            ...
            carouselAdapter =
                CarouselAdapter(actualThumbWidth, actualThumbHeight) { position ->
...
private class CarouselItemViewHolder(
    ...
    private val binding =
        ItemThumbnailCarouselBinding.bind(itemView).also {
            it.ivThumbnailCarousel.layoutParams =
                it.ivThumbnailCarousel.layoutParams.apply {
                    width = thumbWidth
                    height = thumbHeight
                }
        }
